...
class TransformerGNN(nn.Module):
    ...
    def encode_text(self, input_ids, attention_mask):
        """Encode text using frozen transformer (no gradients)"""
    ...
    def encode_text_trainable(self, input_ids, attention_mask):
        """Encode text using transformer (with gradients for joint training)"""
        outputs = self.encoder(input_ids=input_ids, attention_mask=attention_mask)
